defmodule Flightex.Users.UserTest do
  ...
  describe "build/4" do
    ...
    test "should return an error when name isn't bitstring" do
    ...
    test "should return an error when email isn't bitstring" do
    ...
    test "should return an error when cpf isn't bitstring" do
